...
<div id="container">
	...
	<div class="content">
		...
		<div class="cb settings">
			...
			<div class="box-content" style="background-image:url('http://img1.cdn1.habbo.com/c_images/backgrounds2/Habbo_StaffPage_v2.gif')">
				<div style="display:inline-block">
				<cfoutput query="GetStaff">
					<div class="habblet-container" style="width:230px;">
