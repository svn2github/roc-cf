...
<cfelseif step eq "complete">
	...
	<cfquery name = "RegisterAccount" datasource = "#config.DSN#">
		...
		VALUES (<CFQUERYPARAM VALUE="#bean.username#" CFSQLType="CF_SQL_VARCHAR" MAXLENGTH="50">, <CFQUERYPARAM VALUE="#hash(bean.password)#" CFSQLType="CF_SQL_VARCHAR" MAXLENGTH="128">, <CFQUERYPARAM VALUE="#bean.email#" CFSQLType="CF_SQL_VARCHAR" MAXLENGTH="50">, 'm', '#defaultLook#', '#defaultMotto#', UNIX_TIMESTAMP(), '1', '0', '#ipaddress#', '', UNIX_TIMESTAMP(), '#ipaddress#', '<cfif IsDefined("bean.marketing")>1<cfelse>0</cfif>', '<cfif Len(bean.referrer) gt 1><CFQUERYPARAM VALUE="#bean.referrer#" CFSQLType="CF_SQL_VARCHAR" MAXLENGTH="50"><cfelse></cfif>', '#starterCredits#', '#starterPixels#')
	</cfquery>
